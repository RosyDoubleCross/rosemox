...
if (needsInit) {
    db.serialize(function() {
        db.run('CREATE TABLE mosaic (id integer not null, name text not null unique, width integer not null, height integer not null, atomic integer not null, content text, toplevel integer not null, primary key (id));');
